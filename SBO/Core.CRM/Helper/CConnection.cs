...
namespace CConn
{
    public class CConnection
    {
        ...
        // TODO: Security Connection String
        ...
        public static string GetDMISConnectionString()
        {
            return ConfigurationManager.ConnectionStrings["DMISConnectionString"].ToString();
        }
        ...
        {
            return ConfigurationManager.ConnectionStrings["SecurityDBConnectionString"].ToString();
        }
