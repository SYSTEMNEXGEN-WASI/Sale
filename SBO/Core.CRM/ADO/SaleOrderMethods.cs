...
namespace Core.CRM.ADO
{
	public class SaleOrderMethods
	{
        ...
        public static bool Insert_VehicleSaleDetail(VehicleSaleDetailVM[] modelDetail, string trancode, string dealerCode, ref string msg)
        {
            // var code = "MCM01";
            ...
            try
            {
                foreach (var item in modelDetail)
                {
                    ...
                    SqlParameter[] param2 = {
                                     ...
                                     new SqlParameter("@InstallmentPlan",Convert.ToDecimal(item.InstallmentPlan)),//10
                    ...
                    if (sysfun.ExecuteSP_NonQuery("SP_Insert_VehicleSaleDetail", param2, Trans) == true)
                    {
                        IsSaved = true;
                    }
                    else
        ...
        public static List<GetVehicleDetailVM> Get_SaleDetailData(string dealerCode)
        {
            string json = "";
            var Serializer = new JavaScriptSerializer();
            //string DealerCode = "MCM01";
        ...
        public static List<GetVehicleGridDataVM> GridDataa(string TransCode, string DealerCode)
        {
            string json = "";
            var Serializer = new JavaScriptSerializer();
            // string DealerCode = "MCM01";
