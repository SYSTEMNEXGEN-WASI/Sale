   ...
   public class AccountTransactionVM
    {
        ...
        public string SaleBankGuarantee { get; set; }
        public string SaleSecurity { get; set; }
        public string SaleSecurityDesc { get; set; }
        public string SaleBankGuaranteeDesc { get; set; }
